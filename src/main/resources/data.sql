...
insert into car (id, license_plate, rating, seat_count, engine_type, manufacturer, deleted)
values
 (1,
 'KA011805', 2.0, 4, 'GAS', 'BMW',
false);

insert into car (id, license_plate, rating, seat_count, engine_type, manufacturer, deleted)
values
 (2,
 'JH015381', 0.0, 7, 'PETROL', 'AUDI',
false);

insert into car (id, license_plate, rating, seat_count, engine_type, manufacturer, deleted)
values
 (3,
 'DL950451', 0.0, 4, 'ELECTRIC', 'TESLA',
false);

insert into car (id, license_plate, rating, seat_count, engine_type, manufacturer, deleted)
values
 (4,
 'MH781234', 5.0, 4, 'PETROL', 'HONDA',
false);
